...
!!! note "Attribution & License"
    This site is an **unofficial, non-commercial reformatting** of
    [*Neural Networks and Deep Learning*](http://neuralnetworksanddeeplearning.com)
    by **Michael Nielsen**, reflowed for readability as a static site.

    The original work is © Michael Nielsen and licensed under the
    [Creative Commons Attribution-NonCommercial 3.0 Unported License (CC BY-NC 3.0)](https://creativecommons.org/licenses/by-nc/3.0/deed.en).
    This reformatting carries the same license and is provided free, with no
    ads or paid access. It is not affiliated with or endorsed by the
    original author. See `LICENSE-CONTENT.md` for the full attribution
    block and `LICENSE` for terms covering the tooling/CSS/JS in this
    repository only.
...
For more details about the approach taken in the book, [see here](#what-this-book-is-about).  Or you can jump directly to [Chapter 1](chap1.md) and get started.
...
### A principle-oriented approach {#a_principle-oriented_approach}
...
### A hands-on approach {#a_hands-on_approach}
